...
try {
    ...
    $autoReplyHtml = '<!doctype html><html><body style="margin:0;background:#f6f4ef;color:#171714;font-family:Arial,Helvetica,sans-serif;line-height:1.6;padding:24px"><table role="presentation" width="100%" cellspacing="0" cellpadding="0"><tr><td align="center"><table role="presentation" width="100%" style="max-width:620px;background:#fffefa;border:1px solid #dedbd2;border-radius:16px;overflow:hidden" cellspacing="0" cellpadding="0"><tr><td style="padding:28px 32px;border-bottom:4px solid #d86b3d"><img src="https://predictatrade.com/images/logo.png" alt="Predict-A-Trade" width="190" style="display:block;max-width:100%;height:auto"></td></tr><tr><td style="padding:30px 32px;font-size:15px">' . $autoReplyHtml . '<p style="margin:26px 0 0;color:#68665e">Regards,<br><strong>Predict-A-Trade Team</strong><br>Simha FinTech</p>' . $socialHtml . '</td></tr><tr><td style="padding:18px 32px;background:#171714;color:#c8c5bb;font-size:12px">Predict-A-Trade · <a href="https://predictatrade.com/" style="color:#f0a07c">predictatrade.com</a><br>Informational market intelligence. Not financial advice.</td></tr></table></td></tr></table></body></html>';
