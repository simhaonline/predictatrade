...
INSERT INTO licensing.licenses (id, user_id, plan_id, subscription_id, status, license_key, issued_at, valid_from, max_devices, max_mt_accounts, allowed_strategies, allowed_execution_modes, created_by, created_at, updated_at) VALUES
  ...
  ('c1b2c3d4-0003-4000-8000-000000000003', 'a1b2c3d4-0003-4000-8000-000000000003', '38413df8-2109-4566-b293-c915805cdee4', 'b1b2c3d4-0003-4000-8000-000000000003', 'ACTIVE', 'PAT-A1B2C3D4-0003-4000-8000-000000000003', now(), now(), 3, 3, '["STANDARD_SCALPING","ULTRA_SCALPING","STANDARD_SWING","TREND_SWING"]'::jsonb, '["SIGNAL_ONLY","MANUAL","SEMI_AUTO"]'::jsonb, '6d3c51bb-5f91-4494-bdc7-a0b52a572b92', now(), now()),
  ('c1b2c3d4-0004-4000-8000-000000000004', 'a1b2c3d4-0004-4000-8000-000000000004', '7f62ef28-773a-4f25-865b-2eb1d35eda05', 'b1b2c3d4-0004-4000-8000-000000000004', 'ACTIVE', 'PAT-A1B2C3D4-0004-4000-8000-000000000004', now(), now(), 5, 5, '["STANDARD_SCALPING","ULTRA_SCALPING","STANDARD_SWING","TREND_SWING"]'::jsonb, '["SIGNAL_ONLY","MANUAL","SEMI_AUTO","FULL_AUTO"]'::jsonb, '6d3c51bb-5f91-4494-bdc7-a0b52a572b92', now(), now())
ON CONFLICT DO NOTHING;
