      ...
      <div className="rounded-xl border border-pat-border bg-pat-bg-surface p-5">
        ...
        <div className="space-y-4 text-xs">
          ...
          <div>
            ...
            <ul className="space-y-1">
              <li className="flex items-start gap-2 text-pat-text-secondary"><span className="mt-1.5 w-1 h-1 rounded-full bg-pat-text-muted shrink-0" /><span><span className="font-mono text-pat-text-primary">AutoExecute</span> (default <b>true</b> — auto-trading on since EA v1.33) — set false for display-only. This is the main on/off switch.</span></li>
