...
export default function PrivacyPage() {
  return (
    <LegalLayout title="Privacy Policy" lastUpdated="August 2026">
      ...
      <section><h2>UAE PDPL &amp; Consent</h2><p>We comply with the UAE Personal Data Protection Law (PDPL). When you register, we collect three separate, explicit consents: (1) acceptance of Terms &amp; Privacy Policy (required), (2) risk acknowledgment (required), and (3) marketing opt-in (optional — you may register without it). Each consent is logged with a timestamp, the exact consent text and version shown, the state of each checkbox, and your IP address and user-agent, for compliance and audit purposes. You may withdraw marketing consent at any time via the unsubscribe link in any email; opt-outs are honored immediately and persisted.</p></section>
